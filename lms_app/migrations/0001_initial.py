    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phtot_author', models.ImageField(blank=True, null=True, upload_to='photos')),
                ...
                ('status', models.CharField(blank=True, choices=[('avaliable', 'availabe'), ('rental', 'rental'), ('sold', 'sold')], max_length=50, null=True)),
